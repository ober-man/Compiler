...
decl_func :   func_sign func_scope                  {
                                                        ...
                                                        $$ = std::make_shared<FuncNode>(decl_node, scope);
                                                    }
           | func_sign SEMICOLON                    {
...
call: ID LPAR args RPAR                             {
                                                        ...
                                                        $$ = std::make_shared<CallNode>($1, func_decl, func_args);
                                                        driver->clearArgs();
                                                    }
     | ID LPAR RPAR                                 {
                                                        auto&& node = driver->findInGlobalScope($1);
                                                        ...
                                                        auto&& func_decl = std::static_pointer_cast<DeclFuncNode>(node);
                                                        $$ = std::make_shared<CallNode>($1, func_decl);
                                                    }
;
...
input: name ASSIGN SCAN LPAR RPAR SEMICOLON         { $$ = std::make_shared<UnOpNode>($1, unOpType::SCAN); }
;
