...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<BaseNode>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<BaseNode>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::INCR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::INCR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::DECR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::DECR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_QUEST_MARK (location_type l)
      {
        return symbol_type (token::QUEST_MARK, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::QUEST_MARK, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
